<?php
	...
	if(isset($_POST["submit"])){
		...
		$query ="UPDATE `staff` set id=$id,firstName='$fn',lastName='$ln',DOB='$dob',WorkDays='$wd' where id=$id";
        ...
        <div class="col py-3">
            <form method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="firstName" class="form-control" autofocus="on" value=<?php echo $fn;?>>                  
                </div>
                <!-- Last Name -->
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" name="DOB" class="form-control" autofocus="on" value=<?php echo $dob;?>>
                </div>
                <!-- password-->
                <div class="mb-3">
                    <label> Work days :</label>
                    <input type="text" name="WorkDays" class="form-control" value=<?php echo $wd;?>>
                </div> 
                <!-- Submit button  -->
                <div>
