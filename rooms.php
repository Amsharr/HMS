  ...
  <div class="container-fluid">
    <div class="row flex-nowrap">
        ...
        <div class="col py-3">
          ...
          <div>
            <a href="addroom.php">
            <button name="Add" type="Add" class="btn btn-success">Add room</button>
            </a>              
          </div>
            ...
            <tbody>
              ...
              if($result){
                while($row=mysqli_fetch_assoc($result)){
                  ...
                  <td>'.$dd.'</td>
                  <td>
                  <button class="btn btn-primary" name="edit"><a href="editrooms.php?upid='.$id.'" class="text-light">EDIT</a></button>                  
                  <button class="btn btn-danger" name="delete"><a href="rd.php?deleteid='.$id.'" class="text-light">Cancel</a></button>
                  </td>            
                  </tr>';
