<?php
	...
	if(isset($_POST["submit"])){
		...
		$query ="INSERT INTO staff values('','$fn','$ln','$dob','$wd')";
        ...
        <div class="col py-3">
            <form method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="firstName" class="form-control" autofocus="on" >                  
                </div>
                <!-- Last Name -->
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" name="DOB" class="form-control" autofocus="on" >
                </div>
                <!-- Work days-->
                <div class="mb-3">
