<?php
	...
	if(isset($_POST["submit"])){
		...
		$query ="UPDATE `doctors` set id=$id,First_Name='$fn',Last_Name='$ln',Username='$un',Password='$pas' where id=$id";
        ...
        <div class="col py-3">
            <form method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="First_Name" class="form-control" autofocus="on" value=<?php echo $fn;?>>                  
                </div>
                <!-- Last Name -->
                <div class="mb-3">
                    <label> Last Name:</label>
                    <input type="text" name="Last_Name" class="form-control" value=<?php echo $ln;?>>
                </div>
                <!-- username -->
                <div class="mb-3">
                    <label> Username:</label>
                    <input type="text" name="Username" class="form-control" autofocus="on" value=<?php echo $un;?>>
                </div>
                <!-- password-->
                <div class="mb-3">
                    <label> Password:</label>
                    <input type="text" name="Password" class="form-control" value=<?php echo $pas;?>>
                </div> 
                <!-- update button  -->
                <div>
