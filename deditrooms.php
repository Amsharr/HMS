<?php
	...
	if(isset($_POST["submit"])){
		...
		$query ="UPDATE `rooms` set id=$id,nameOfPatient='$nop',nameOfDoctor='$nod',RoomNo='$rn',admittedDay='$ad',dishchargeDay='$dd' where id=$id";
		mysqli_query($conn, $query);
		echo '<script>
        window.location.href ="droom.php";
        ...
        <div class="col py-3">
            <form method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" name="admittedDay" class="form-control" autofocus="on" value=<?php echo $ad;?>>
                </div>
                <!-- Dishcharge day-->
                <div class="mb-3">
                    <label>Dishcharge day:</label>
                    <input type="date" name="dishchargeDay" class="form-control" value=<?php echo $dd;?>>
                </div> 
                <!-- update button  -->
                <div>
