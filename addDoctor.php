...
if(isset($_POST["submit"])){
    ...
    $query = "INSERT INTO doctors VALUES('','$firstName','$lastName','$username','$password')";
        ...
        <div class="col py-3">
            <form method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="First_Name" class="form-control" autofocus="on">                  
                </div>
                <!-- Last Name -->
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="Username" class="form-control" autofocus="on">
                </div>
                <!-- password-->
                <div class="mb-3">
