            ...
            <tbody>
              ...
              if($result){
                while($row=mysqli_fetch_assoc($result)){
                  ...
                  <td>'.$dd.'</td>
                  <td>
                  <button class="btn btn-primary" name="edit"><a href="deditrooms.php?upid='.$id.'" class="text-light">EDIT</a></button>                  
                  <button class="btn btn-danger" name="delete"><a href="drd.php?deleteid='.$id.'" class="text-light">Cancel</a></button>
                  </td>            
                  </tr>';
