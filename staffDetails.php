  ...
  <div class="container-fluid">
    <div class="row flex-nowrap">
        ...
        <div class="col py-3">
          ...
          <a href="addStaff.php">
          <div>
              <button name="Add" type="Add" class="btn btn-success">Add staff</button>
          </div>
          </a>          
        <table class="table">
            <thead>
            ...
            <tbody>
              ...
              if($result){
                while($row=mysqli_fetch_assoc($result)){
                  ...
                  <td>'.$wd.'</td>
                  <td>
                  <button class="btn btn-primary" name="edit"><a href="sedit.php?upid='.$id.'" class="text-light">EDIT</a></button>
                  <button class="btn btn-danger" name="delete"><a href="sdelete.php?deleteid='.$id.'" class="text-light">DELETE</a></button>                  
                  </td>                           
                  </tr>';
                }
