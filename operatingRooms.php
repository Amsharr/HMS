            ...
            <tbody>
              ...
              if($result){
                while($row=mysqli_fetch_assoc($result)){
                  ...
                  <td>'.$et.'</td>
                  <td>
                  <button class="btn btn-primary" name="edit"><a href="editop.php?upid='.$id.'" class="text-light">EDIT</a></button>
                  </td>  
                  <td>
                  <button class="btn btn-danger" name="delete"><a href="deleteop.php?deleteid='.$id.'" class="text-light">DELETE</a></button>
                  </td>          
                  </tr>';
                }                
              }
