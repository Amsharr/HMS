  ...
  <div class="container-fluid">
    <div class="row flex-nowrap">
        ...
        <div class="col py-3">
          ...
          <div>
              <button name="Add" type="Add" class="btn btn-success">Add Doctor</button>
          </div>
          </a>          
            ...
            <tbody>
              ...
              if($result){
                while($row=mysqli_fetch_assoc($result)){
                  ...
                  <td>'.$pas.'</td>
                  <td>
                  <button class="btn btn-primary" name="edit"><a href="docedit.php?upid='.$id.'" class="text-light">EDIT</a></button>                  
                  </td> 
                  <td>
                  <button class="btn btn-danger" name="delete"><a href="docdelete.php?deleteid='.$id.'" class="text-light">DELETE</a></button>
                  </td>             
                  </tr>';
